...
class Game {
 ...
 public:
    ...
    /**
     * @brief Returns 1 if the player has died, 2 if it has won or otherwise 0.
     */
    int exit_code() const {return exit_code_;}

    /**
     * @brief Creates a new coin and adds it to the finder.
     */
    void spawn_coin(pro2::Pt pos, pro2::DoubPt vel);

    /**
     * @brief Updates the animation counter to go to the next sprite.
     */
    void anim_step() {
        curr_anim_frame_++;
        curr_anim_frame_ %= 18;
